...
and also being a fast and reliable way to access the on-premise server data quickly which enbles faster deicion making. The infrastructure setup cost is to be mentioned, as
